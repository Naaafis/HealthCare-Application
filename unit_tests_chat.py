...
def test_send_message():
    test_dict = {sender: 'sender_name', recipient: 'recipient_name', message: 'message'}
    func_dict = uc.send_message('sender_name', 'recipient_name', 'message')
...
def test_check_message(): 
    ...
    func_dict = uc.send_message(12, 'recipient_name', 'message')
    test = uc.check_message(func_dict)
    ...
    func_dict = uc.send_message('sender_name', 12, 'message')
    test = uc.check_message(func_dict)
